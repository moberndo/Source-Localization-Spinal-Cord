...
# ----- FUNCTIONS -----
def Create16ChannelSimPlot(data, fs):
    """
    ...
    axes = [ax1, ax2, ax3, ax4, ax5, ax6, ax7, ax8, ax9, ax10, ax11, ax12,
            ax13, ax14, ax15, ax16]
    titles = ['Sp2', 'Sp5', 'Sp8', 'Sp11', 'Sp14', 'Sp1', 'Sp4','Sp7', 'Sp10',
            'Sp13', 'Sp16', 'Sp3', 'Sp6', 'Sp9', 'Sp12', 'Sp15',]
    for idx, ax in enumerate(axes):
        max_val = max(data[idx, :])
        min_val = min(data[idx, :])
        ax.vlines(0, min_val, max_val, colors = 'grey', linestyles = 'dashed')
        ax.vlines(1, min_val, max_val, colors = 'grey', linestyles = 'dashed')
        ax.plot(t, data[idx,:], 'k', alpha = 1, linewidth = '1')
        ax.set_title(titles[idx])

def LeadField(user_ID, main_path, leadfield_params):
    """
    ...
    path_LeadField = main_path / 'data' / folder_user / leadfield_name
